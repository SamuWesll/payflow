...
import 'package:payflow/moduiles/barcode_scanner/barcode_scanner_controller.dart';
import 'package:payflow/moduiles/barcode_scanner/barcode_scanner_status.dart';
              ...
              builder: (_, status, __) {
                if (status.hasErro) {
                  return ButtonSheetWidget(
                    ...
                    subtitle:
                        "Tente scanear novamente ou digite o código do seu boleto.",
